               ...
               <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php
                         ...
                         if(isset($_SESSION['user'])) {
                              $user = $_SESSION['user'];
                              echo  "<li><a href='' class='fas fa-user icon'> $user</a></li>";
                        
                              
                         } else {
                              echo '<li><a href="princ.php" class="smoothScroll">Iniciar sesión</a></li>';
                         }
                    ...
                    <?php
                         if(isset($_SESSION['user'])) {
                              echo '<li><a href="index.php?out=3232" class="smoothScroll">Cerrar sessión</a></li>';
                         }
                    ?>
...
<section id="contact" class="parallax-section">
 ...
 <a href="http://localhost/pagina%20web%201/tienda.html"> <button type="button" class="form-control" id="cf-submit" name="submit"><span data-hover="Abrir tienda">Abrir tienda</span></button></a>
